...
@st.cache_resource
def load_model(custom_model_path='runs/detect/custom_yolov8/weights/best.pt'):
...
def main():
    ...
    model = load_model('runs/detect/custom_yolov8/weights/best.pt')  # Replace with your model path
